 ...
 * WARNING: This is WRONG. We should compute these stats before we do the MI filter.
 * This code will compute based on the positive instances of the training set.
 * Please use VerbObjectStatComputer instead.
 */
public class WrongVerbObjectStatComputer {
	...
	public WrongVerbObjectStatComputer() {
		reset();
	}
